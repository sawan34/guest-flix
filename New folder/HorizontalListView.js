        ...
        switch (keyCode) {
            case KeyMap.VK_RIGHT:
                ...
                this.setState((prevState) => {
                    return { focusLostItemPosition: prevState.scrollIndex, scrollIndex: prevState.scrollIndex + 1, activeIndex: prevState.activeIndex + 1 }
                }, () => {
                    this.focusChange();
                    this.nextIndexDataLoad(this.state.scrollIndex - 1)
                    //this.setState({ tranlateNow: false});
                });
                break;
            case KeyMap.VK_LEFT:
