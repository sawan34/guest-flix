...
class BaseGrid extends Component {
    ...
    */
    initData = () => {
        this.setDataSource();
        let toVisibleIndex = this.getMaxVisibleItem();
    ...
    */
    ...
    previousIndexDataLoad(fromVisibleIndex) {
        if (fromVisibleIndex >= 1) {
            ...
            this.loadData(fromPos, toPos)
            this.scrollInit(1);
            console.log("from pos" + fromPos + " --- " + " To Pos" + toPos)
        }
    }
    ...
    */
    ...
    sliderStyle() {
        ...
        console.log("this.state.tranlateNow "+this.state.tranlateNow);
        if(this.state.tranlateNow===true){
            console.log("Set UL here "+this.scrollX);
            style = {
                transform: "translate3d(" + this.scrollX + "px,0,0)",
                width: ((parseInt(this.getMaxVisibleItem())) * (this.itemWidth + this.itemPadding) + 'px'),
            }
        }else{
            if(this.state.tranalateo){
    ...
    performAndDisapper = () => {
        console.log("performAndDisapper called ");
        const element = document.getElementById('animation-root');
        console.log("performAndDisapper called "+element);
    ...
    render() {
        ...
        return (
            <div >
                <ul id="animation-root" className="slider" style={this.sliderStyle()} >
